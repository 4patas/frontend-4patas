...
const AdicionarUsuario = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (senha !== confirmarSenha) {
               setMessage('Erro ao adicionar usuário: senhas não coincidem.');
               return;
            } else {
    ...
    return (
        <div className="container">
           ...
           <p>Falta poucos passos até você encontrar seu novo amigo.</p>
            <form onSubmit={handleSubmit}>
                ...
                <input type="password" id="senha" value={confirmarSenha} onChange={(e) => setConfirmarSenha(e.target.value)} required />
